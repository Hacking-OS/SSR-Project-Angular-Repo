...
import { HttpCartEndPointService } from './cart-end-point.HttpService';
...
export class HttpCartService {
  // constructor(private cartEndPointService:HttpCartEndPointService) { }
  private httpEndPointService: HttpCartEndPointService;
  constructor(private http: HttpClient, private injector: Injector,private sharedService:SharedService) {
    ...
    this.httpEndPointService = new HttpCartEndPointService(this.http, endpointBase,this.sharedService);
  }

  GetApiResponse<responseType, paramType>(path: string, obj: paramType, postTypeResponse?: PostType, responseType: 'arraybuffer' | 'blob' | 'json' | 'text' = 'json', observe: 'body' | 'response' | 'events' = 'body') {
    return this.httpEndPointService.GetApiResponse<responseType, paramType>(path, obj, postTypeResponse, responseType, observe);
  }
